...
function OutputCard({ output }: { output: InventoryPlanOutput }) {
  return (
    <article className="rounded-md border-2 border-[#c9b88a] bg-[#fffdf5] p-2 shadow-[0_2px_0_#b29c66] transition hover:-translate-y-0.5 hover:shadow-[0_4px_0_#b29c66]">
